...
Const
  DEH_DEFAULT_INITIAL_HEALTH = 100;
  DEH_DEFAULT_INITIAL_BULLETS = 50;
  DEH_DEFAULT_MAX_HEALTH = 200;
  DEH_DEFAULT_MAX_ARMOR = 200;
  DEH_DEFAULT_GREEN_ARMOR_CLASS = 1;
  DEH_DEFAULT_BLUE_ARMOR_CLASS = 2;
  DEH_DEFAULT_MAX_SOULSPHERE = 200;
  DEH_DEFAULT_SOULSPHERE_HEALTH = 100;
  DEH_DEFAULT_MEGASPHERE_HEALTH = 200;
  DEH_DEFAULT_GOD_MODE_HEALTH = 100;
  DEH_DEFAULT_IDFA_ARMOR = 200;
  DEH_DEFAULT_IDFA_ARMOR_CLASS = 2;
  DEH_DEFAULT_IDKFA_ARMOR = 200;
  DEH_DEFAULT_IDKFA_ARMOR_CLASS = 2;
  DEH_DEFAULT_BFG_CELLS_PER_SHOT = 40;
  DEH_DEFAULT_SPECIES_INFIGHTING = 0;

  // Dehacked: "Initial Health"
  // This is the initial health a player has when starting anew.
  // See G_PlayerReborn in g_game.c
  deh_initial_health: int = DEH_DEFAULT_INITIAL_HEALTH;

  // Dehacked: "Initial bullets"
  // This is the number of bullets the player has when starting anew.
  // See G_PlayerReborn in g_game.c

  deh_initial_bullets: int = DEH_DEFAULT_INITIAL_BULLETS;

  // Dehacked: "Max Health"
  // This is the maximum health that can be reached using health
  // potions. See P_TouchSpecialThing in p_inter.c

  deh_max_health: int = DEH_DEFAULT_MAX_HEALTH;

  // Dehacked: "Max Armor"
  // This is the maximum armor which can be reached by picking up
  // armor helmets. See P_TouchSpecialThing in p_inter.c

  deh_max_armor: int = DEH_DEFAULT_MAX_ARMOR;
  ...
  deh_green_armor_class: int = DEH_DEFAULT_GREEN_ARMOR_CLASS;
  ...
  deh_blue_armor_class: int = DEH_DEFAULT_BLUE_ARMOR_CLASS;
  ...
  deh_max_soulsphere: int = DEH_DEFAULT_MAX_SOULSPHERE;
  ...
  deh_soulsphere_health: int = DEH_DEFAULT_SOULSPHERE_HEALTH;
  ...
  deh_megasphere_health: int = DEH_DEFAULT_MEGASPHERE_HEALTH;
  ...
  deh_species_infighting: int = DEH_DEFAULT_SPECIES_INFIGHTING;
